...
<body>
  ...
  <div style="margin-top: 48pt; border-top: 1px solid #e5e7eb; padding-top: 12pt; font-size: 10pt; color: #9ca3af;">
    <p>Generated by ClarityAI | ${new Date().toLocaleString()}</p>
  </div>
</body>
</html>`;
...
{note:title=Generated by ClarityAI}
This document was automatically generated. Last updated: ${new Date().toLocaleString()}
{note}
`;
